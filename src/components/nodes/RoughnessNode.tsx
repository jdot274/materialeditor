...
export function RoughnessNode({ data, id }: { data: { value: number }, id: string }) {
  const { setRoughness } = useMaterialStore();
  ...
  }, [id, inputValue, setRoughness]);

  return (
    <div className="bg-white rounded-lg shadow-lg p-4">
      <div className="text-sm font-medium mb-2">Roughness</div>
      <input
        type="number"
        step="0.1"
        min="0"
